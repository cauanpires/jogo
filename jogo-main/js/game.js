...
const pontuação = document.querySelector(".Pontuação-valida");


const maisponto = () =>{
    pontuação.innerHTML = parseInt(pontuação.innerHTML) + 10;
};

const menosponto = () =>{
    pontuação.innerHTML = parseInt(pontuação.innerHTML) - 1;
};
